...
<?php if (dsmart_analytics_allowed()) : ?><p><a href="<?php echo esc_url(add_query_arg('section', 'statistics', get_permalink())); ?>"><?php esc_html_e('Statistik & Analyse öffnen', 'dsmart'); ?></a></p><?php endif; ?>
