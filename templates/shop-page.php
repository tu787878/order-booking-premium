...
<?php if (dsmart_analytics_allowed()) : ?>					<li class="<?php if(isset($_GET['section']) && $_GET['section'] == "statistics"){echo 'active';} ?>"><a href="<?php echo get_permalink().'?section=statistics'; ?>"><?php _e("Statistik & Analyse") ?></a></li><?php endif; ?>
				</ul>
			</div>
